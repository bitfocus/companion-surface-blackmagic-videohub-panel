/**
 * Generates the initial prelude message that is sent to clients when they connect
 * @returns The prelude message containing device information and initial state
 */
